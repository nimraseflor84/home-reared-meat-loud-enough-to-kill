...
func _draw() -> void:
	...
	var leg_1  = -_wc * 5.0       # vorne-links (gegenlaeufig)
	var leg_2  = -_wc * 5.0       # hinten-rechts (gegenlaeufig)
	...
	# Runder Koerper (South Park: breiter, flacher Kreis)
...
func _draw_death() -> void:
	...
	# Koerper (Rotation durch _on_dying_process, bleibt sichtbar)
